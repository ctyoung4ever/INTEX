...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                ...
                optionsBuilder.UseNpgsql("Server=mummy.cfmesdu5ufuo.us-east-1.rds.amazonaws.com;Port=5432;Database=mummy;User Id=postgres;Password=intex1-11?postrds;");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<C14>(entity =>
            {
                ...
                entity.Property(e => e.CalendardateEnd).HasColumnName("calendardate_end");

                entity.Property(e => e.CalendardateStart).HasColumnName("calendardate_start");

                entity.Property(e => e.CalenderdateBcAd)
                    .HasColumnName("calenderdate_bc_ad")
                    .HasMaxLength(2000);
